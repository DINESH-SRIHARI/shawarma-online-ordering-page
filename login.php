...
<body>
  <?php require 'header.php'; ?>
    ...
    <div class="container cont">
      ...
      <li class="nav-item">
        <a class="nav-link active" data-toggle="tab" href="#hospitals">Admin</a>
      </li>
     <li class="nav-item">
    ...
    <div class="tab-content">
       <div class="tab-pane container active" id="hospitals">
        <form action="file/hospitalLogin.php" method="post">
          <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Admin Email</label>
          <input type="email" name="hemail" placeholder="Admin Email" class="form-control mb-4">
          <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Admin Password</label>
          <input type="password" name="hpassword" placeholder="Admin Password" class="form-control mb-4">
