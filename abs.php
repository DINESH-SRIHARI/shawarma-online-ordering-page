...
<body>
    ...
    <div class="container cont">
        ...
        <table class="table table-responsive table-striped rounded mb-5">
            <tr><th colspan="7" class="title">Available Shawarmas</th></tr>
            <tr>
                <th>#</th>
                <th>Shawarma Name</th>
                <th>Veg/Non</th>
        ...
        <?php while($row = mysqli_fetch_array($result)) { ?>
            ...
            <tr>
                ...
                <td><input type="submit" name="request" class="btn btn-info" value="Place Order"></td>
                <?php } ?>
