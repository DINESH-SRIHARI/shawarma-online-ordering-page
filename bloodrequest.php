...
<!DOCTYPE html>
<html>
<?php $title="Shawarma | shawarma Requests"; ?>
...
<body>
	...
	<table class="table table-responsive table-striped rounded mb-5">
		<tr><th colspan="10" class="title">Shawarma requests</th></tr>
		<tr>
			<th>#</th>
			<th>Name</th>
			<th>Email</th>
		...
		<tr>
			...
			<td><?php if($row['status'] == 'Accepted'){ ?> 
			 <a href="" class="btn btn-success disabled">Accepted</a> <?php }
				...
				<!-- <button class="btn btn-info" onclick="hideRow(this)">Hide</button> -->
			<?php } ?>
			</td>
			<td><?php if($row['status'] == 'Rejected'){ ?> <a href="" class="btn btn-danger disabled">Reject</a> <?php }
			else{ ?>
				<a href="file/reject.php?reqid=<?php echo $row['reqid'];?>" class="btn btn-danger">Cancel</a>
			<?php } ?>
			</td>
			<td><?php if($row['status'] == 'Accepted'){ ?> 
				<button class="btn btn-info" onclick="hideRow(this)">Hide</button>
